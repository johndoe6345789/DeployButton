...
public:
    ...
    ADD_METHOD_TO(WorkflowsController::update, "/api/workflows/{1}", drogon::Put);
    ADD_METHOD_TO(WorkflowsController::remove, "/api/workflows/{1}", drogon::Delete);
    ADD_METHOD_TO(WorkflowsController::updateSteps, "/api/workflows/{1}/steps", drogon::Put);
    METHOD_LIST_END
    ...
    void remove(const drogon::HttpRequestPtr &req,
                std::function<void(const drogon::HttpResponsePtr &)> &&callback,
                long long id);
    void updateSteps(const drogon::HttpRequestPtr &req,
                      std::function<void(const drogon::HttpResponsePtr &)> &&callback,
                      long long id);
};
}  // namespace deploybutton
